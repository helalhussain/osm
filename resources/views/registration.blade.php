...
>
  <head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="{{ asset('teacher') }}/assets/vendor/libs/bs-stepper/bs-stepper.css" />
    <link rel="stylesheet" href="{{ asset('teacher') }}/assets/vendor/libs/bootstrap-select/bootstrap-select.css" />
  ...
  <body>
    ...
    <div class="authentication-wrapper authentication-cover authentication-bg">
      <div class="authentication-inner row">
        ...
        >
          <img
            src="{{ asset('teacher') }}/assets/img/illustrations/auth-register-multisteps-illustration.png"
        ...
        <div class="d-flex col-lg-8 align-items-center p-sm-5 p-3">
                ...
                <form id="multiStepsForm" onSubmit="return false">
                  ...
                  <div id="accountDetailsValidation" class="content">
                    ...
                    <div class="row g-3">
                      ...
                      {{-- <div class="col-md-12">
                        <label class="form-label" for="multiStepsURL">Student ID</label>
                        <input
                          type="text"
                          name="multiStepsURL"
                          id="multiStepsURL"
                        ...
                        <div class="form-check custom-option custom-option-icon">
                          <label class="form-check-label custom-option-content" for="standardOption">
                            <span class="custom-option-body">
                              ...
                              <span class="d-flex justify-content-center">
                                <sup class="text-primary fs-6 lh-1 mt-3">$</sup>
                                <span class="fw-semibold fs-2 text-primary">2500</span>
                                <sub class="lh-1 fs-6 mt-auto mb-2 text-muted">/year</sub>
                              </span>
                            </span>
                            <input
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('teacher') }}/assets/vendor/libs/cleavejs/cleave.js"></script>
    <script src="{{ asset('teacher') }}/assets/vendor/libs/cleavejs/cleave-phone.js"></script>
    <script src="{{ asset('teacher') }}/assets/vendor/libs/bs-stepper/bs-stepper.js"></script>
    ...
    <!-- Page JS -->
    <script src="{{ asset('teacher') }}/assets/js/pages-auth-multisteps.js"></script>
  </body>
</html>
