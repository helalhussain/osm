...
@section('administator_content')
     ...
     <!-- end page title -->
     <x-admin.page-title dashboard_title="Administator" title="Dashboard" page_name="Password">
    ...
    <div class="row">
        <div class="card p-5">
            ...
            <section>
                ...
                <form  method="post" action="{{ route('administator.password.update') }}" class="mt-6 space-y-6">
                    @csrf
                    @method('put')
