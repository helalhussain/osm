...
<x-admin.page-title dashboard_title="Administator" title="Student Message" page_name="All send">
            ...
            <div class="col-12">
                ...
                <div class="email-leftbar card">
                    ...
                    <div class="mail-list mt-4">
                        <a href="{{ route('administator.student-message.index') }}" class="{{ Request::is('administator.student-message.index') ? 'active':'' }}"><i class="mdi mdi-email-outline me-2"></i> Inbox <span class="ms-1 float-end">({{ $m_administator_count->count() }})</span></a>
                        <a href="{{ route('administator.student-message.send') }}" class="{{ Request::is('administator.student-message.send') ? '':'active' }}"><i class="mdi mdi-email-check-outline me-2"></i>Sent <span class="ms-1 float-end">({{ $m_count->count() }})</span></a>
                    </div>
                </div>
                <!-- End Left sidebar -->
