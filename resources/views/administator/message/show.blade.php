            ...
            <div class="col-12">
                ...
                <div class="email-leftbar card">
                    ...
                    <div class="mail-list mt-4">
                        <a href="{{ route('administator.message.index') }}" class="text-danger"><i class="mdi mdi-email-outline me-2"></i> Inbox <span class="ms-1 float-end">({{ $recieve_message->count() }})</span></a>
                        <a href="{{ route('administator.message.send') }}" class=""><i class="mdi mdi-email-check-outline me-2"></i>Sent <span class="ms-1 float-end">({{ $t_m_administrator->count() }})</span></a>
                        ...
                        <div class="card-body">
                            <div class="media mb-4">
                                ...
                                <div class="media-body">
                                    ...
                                    @endif --}}
                                    @if ($message->administrator=='recieve')
                                   @if ($message->teach=='send')
                                   <h5 class="font-size-16 ">{{  $message->teacher->name }}</h5>
                                   <small class="text-muted mb-2">{{ $message->teacher->email }}</small>
