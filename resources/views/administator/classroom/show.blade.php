...
<x-admin.page-title  dashboard_title="Administator" title="Class" page_name="Show Class">
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                        <a href="${route('administator.classroom.show',row.id) }" class="btn btn-outline-success btn-sm" id=""><i class="fas fa-eye"></i></a>
