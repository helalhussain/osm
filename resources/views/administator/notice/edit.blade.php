...
@section('administator_content')
    <x-admin.page-title dashboard_title="Administator" title="notice" page_name="Edit notice">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="" action="{{ route('administator.notice.update',$notice->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
