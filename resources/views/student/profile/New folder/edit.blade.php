                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                      ...
                      <hr class="my-0" />
                      <div class="card-body">
                        <form id="submit" method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                          @csrf
                          @method('patch')
                            <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              <input class="form-control @error('student_id')
                                is-invalid
                              @enderror" readonly type="text" name="student_id" id="student_id" value="{{ auth()->user()->student_id }}" />
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select id="gender" class="select2 form-select @error('gender')
                                is-invalid
                                @enderror">
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              is-invalid
                            @enderror" id="address" name="address" value="{{ auth()->user()->address }}" placeholder="Address" />
                            </div>
                            {{-- <div class="mb-3 col-md-6">
                          ...
                          <div class="mt-2">
                            ...
                            <a href="{{ route('profile.index') }}" class="btn btn-label-secondary">Cancel</a>
                          </div>
                        </form>
                      </div>
                      <!-- /Account -->
