    ...
    <div class="page-content-wrapper">
     ...
     <div class="email-leftbar card">
        ...
        <div class="mail-list mt-4">
            <a href="{{ route('message.index') }}" class="text-danger"><i class="mdi mdi-email-outline me-2"></i> Inbox <span class="ms-1 float-end">({{ $student_recieve->count() }})</span></a>
            <a href="{{ route('message.send') }}" class="" ><i class="mdi mdi-email-check-outline me-2 "></i>Sent <span class="ms-1 float-end">({{ $m_t_student->count() }})</span></a>
        </div>
    </div>
    <!-- End Left sidebar -->
