                    ...
                    <div class="col app-chat-sidebar-left app-sidebar overflow-hidden" id="app-chat-sidebar-left">
                      ...
                      >
                        <div class="avatar avatar-xl avatar-online">
                          <img src="{{ asset('teacher') }}/assets/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
                        </div>
                      ...
                      <div class="sidebar-body px-4 pb-4">
                        <div class="my-4">
                          ...
                          <textarea
                            ...
                            maxlength="120"
                          >
  Dessert chocolate cake</textarea
                          >
                        </div>
                        <div class="my-4">
                    ...
                    >
                      <div class="sidebar-header">
                        <div class="d-flex align-items-center">
                          ...
                          >
                            <img
                              ...
                              src="{{ asset('teacher') }}/assets/img/avatars/1.png"
                              alt="Avatar"
                            />
                          </div>
                        ...
                        <i
                          class="ti ti-x cursor-pointer close-sidebar d-lg-none d-block position-absolute top-0 end-0"
                          data-overlay
                          data-bs-toggle="sidebar"
...
<li class="chat-contact-list-item">
    <a href="{{ route('chat.show',$teacher->id) }}" class="d-flex align-items-center">
      <div class="flex-shrink-0 avatar avatar-online">
        <img src="{{ uploaded_file('image')}}" alt="Avatar" class="rounded-circle" />
      </div>
      <div class="chat-contact-info flex-grow-1 ms-2">
        <h6 class="chat-contact-name text-truncate m-0">{{ $teacher->name }}</h6>
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex overflow-hidden align-items-center">
                              ...
                              <div class="flex-shrink-0 avatar">
                                <img
                                  src="{{ asset('teacher') }}/assets/img/avatars/2.png"
                                  alt="Avatar"
                            ...
                            <li class="chat-message">
                              <div class="d-flex overflow-hidden">
                                <div class="user-avatar flex-shrink-0 me-3">
                                  <div class="avatar avatar-sm">
                                    <img src="{{ asset('teacher') }}/assets/img/avatars/2.png" alt="Avatar" class="rounded-circle" />
                                  </div>
                                </div>
                                <div class="chat-message-wrapper flex-grow-1">
                                  <div class="chat-message-text">
