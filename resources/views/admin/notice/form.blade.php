...
@section('admin_content')
    <x-admin.page-title dashboard_title="Admin" title="notice" page_name="Create notice">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="submi" action="{{ route('admin.notice.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                ...
                                <div><br/>
                                    <textarea  class="form-control your_summernote" name="description" rows="5" placeholder="Type here"></textarea>
                                @error('description')
