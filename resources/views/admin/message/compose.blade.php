...
<x-admin.page-title dashboard_title="Admin" title="Message" page_name="Compose">
    <a href="{{ route('admin.message.index') }}" class="btn btn-success" id="addBtn">All message</a>
</x-admin.page-title>
