...
<x-admin.page-title dashboard_title="Admin" title="Message" page_name="All message">
    <a href="{{ route('admin.message.create') }}" class="btn btn-success" id="addBtn">Add message</a>
</x-admin.page-title>
