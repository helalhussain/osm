            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                        <a href="${route('admin.teacher.show',row.id) }" class="btn btn-outline-success btn-sm" id=""><i class="fas fa-eye"></i></a>
                    <a href="${route('admin.teacher.destroy',row.id) }" class="btn btn-outline-danger btn-sm" id="deleteBtn"><i class="fas fa-trash-alt"></i></a>
