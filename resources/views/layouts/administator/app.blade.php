@include('layouts.administator.partials.style')

    <!-- Begin page -->

   @include('layouts.administator.partials.header')
   @include('layouts.administator.partials.sidebar')
...
@yield('administator_content')

@include('layouts.administator.partials.footer')
        <!-- end main content-->
...
@include('layouts.administator.partials.script')
