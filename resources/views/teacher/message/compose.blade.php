...
<x-admin.page-title dashboard_title="teacher" title="Student Message" page_name="Compose message">
    <a href="{{ route('teacher.message.index') }}" class="btn btn-success" id="">All message</a>
</x-admin.page-title>
            ...
            <div class="col-12">
                ...
                <div class="email-leftbar card">
                    ...
                    <div class="mail-list mt-4">
                        <a href="{{ route('teacher.message.index') }}" class=""><i class="mdi mdi-email-outline me-2"></i> Inbox <span class="ms-1 float-end">({{ $recieve_message->count() }})</span></a>
                ...
                <div class="email-rightbar mb-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="submi" action="{{ route('teacher.message.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
<div class="row">
    <div class="col-lg-6">
    ...
    <div class="col-lg-6">
        <div class="form-group mb-3">
            ...
            {{-- <input type="email" class="form-control" placeholder="To"> --}}
            <select name="administator_email" id="administator_email" class="form-control select2">
