...
<x-admin.page-title dashboard_title="teacher" title="Message" page_name="All send">
...
<li>
    <div class="col-mail col-mail-1">
        ...
        <a href="{{ route('teacher.message.send_show',$message->id) }}" class="title">
    ...
    <div class="col-mail col-mail-2">
        <a href="{{ route('teacher.message.send_show',$message->id) }}" class="subject"> <span class="teaser">{{ $message->message }}</span>
        </a>
