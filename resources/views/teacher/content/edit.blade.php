...
@section('teacher_content')
    <x-admin.page-title dashboard_title="Teacher" title="Teacher" page_name="edit">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="" action="{{ route('teacher.content.update',$content->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="subject" id="subject" class="form-control select2" required>
                                                <option value="{{ $content->subject ?? '' }}">{{ $content->subject ?? 'Select Subject' }}</option>
                                    ...
                                    <x-admin.form-group label="title" class="mb-3" :value="$content->title ?? ''" placeholder="Enter title"
                                    ...
                                    @enderror
                                      ...
                                      <x-admin.submit-button :text="isset($content) ? 'Update':'Submit'" />
