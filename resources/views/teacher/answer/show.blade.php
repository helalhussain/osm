                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            {{-- <h5 class="font-size-18 text-uppercase"></h5> --}}
                                            <p class="text-muted mb-0"><strong>{{ $answer->name }} </strong></p>
                                            <p class="text-muted mb-0"> {{ $answer->email }}</p><br/>
                                            <p class="text-muted mb-0"><strong>Q.{{ $answer->question }} | mark:{{ $answer->mark }} | Achieve: 0 </strong></p>
                                            <p class="text-muted mb-0">Ans : {!! $answer->ans !!} </p>
                                        </div>
